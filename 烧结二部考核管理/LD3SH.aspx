<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LD3SH.aspx.cs" Inherits="LD3SH"  EnableEventValidation="false" validateRequest="false"%>
<!DOCTYPE html>
...
<asp:Label ID="Label4" runat="server" Text="考核编号:"></asp:Label>
 ...
 <asp:Label ID="Label12" runat="server" Text="被考核工段:"></asp:Label>
  ...
  <asp:Label ID="AppraiseGroup" runat="server" Text="空"></asp:Label>
              ...
              <td style="width:15%">
 <asp:Label ID="Label14" runat="server" Text="考核金额:"></asp:Label>
            </td>
             <td>
 ...
 <asp:Label ID="Label15" runat="server" Text="考核内容:"></asp:Label> 
            </td>
...
<asp:Label ID="Leader_2_State" runat="server" Text="空"></asp:Label>
    ...
    <asp:Label ID="Label1" runat="server" Text="主任审批" Font-Bold="False" Font-Size="Larger"></asp:Label>
<hr />
            <table style="width:100%">
                <tr>
                    <td style="width:15%">
 <asp:Label ID="Label10" runat="server" Text="主任审批状态:"></asp:Label>
          
                    </td>
                     <td style="width:15%">
  <asp:DropDownList ID="ddl1_ld3sp_zt" runat="server">
                ...
                <asp:ListItem>不同意</asp:ListItem>
                    ...
                    <td style="width:15%">
                     ...
                     <td style="width:15%" >
                           <asp:TextBox ID="tbx_ld3sp_kh_jiner" runat="server" Height="16px" Width="100%" Enabled="False" ></asp:TextBox>
                    </td>
                </tr>
            </table>
       <table style="width:100%">
        ...
        <asp:Label ID="Label13" runat="server" Text="主任审批意见:" ></asp:Label>
               </td>
               </tr>
           <tr>
               <td colspan="3" >
            <asp:TextBox ID="tb1_ld3sp_yj" runat="server" Height="225px" Width="100%" TextMode="MultiLine"></asp:TextBox>
               </td>
           </tr>
      <tr>
               <td colspan="3">  
...
<hr />
 ...
 <asp:Label ID="Label33" runat="server" Text="反馈状态:"></asp:Label>
                     ...
                     <td>
  <asp:DropDownList ID="ddl_khfk_zt" runat="server">
                <asp:ListItem Selected="True">同意</asp:ListItem>
                <asp:ListItem>不同意</asp:ListItem>
            </asp:DropDownList>
                    </td>
 ...
 <asp:Label ID="Label11" runat="server" Text="点检操作是否超时:" Visible="False"></asp:Label>
