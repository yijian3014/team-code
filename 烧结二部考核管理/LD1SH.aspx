 ...
 <asp:Label ID="Label10" runat="server" Text="主管领导审批状态:"></asp:Label>
  ...
  <asp:DropDownList ID="ddl1_ld1sp_zt" runat="server">
       ...
       <table style="width:100%">
        ...
        <asp:Label ID="Label13" runat="server" Text="主管领导审批意见:" ></asp:Label>
               </td>
               </tr>
           <tr>
               <td colspan="3" >
            <asp:TextBox ID="tb1_ld1sp_yj" runat="server" Height="225px" Width="100%" TextMode="MultiLine"></asp:TextBox>
               </td>
           </tr>
      <tr>
               <td colspan="3">  
