...
public partial class LD1SH : System.Web.UI.Page
{
    ...
    {
        if (Session["UserID"].ToString() == "" || Session["UserID"] == null|| Convert.ToInt16(Session["UserID"])/1000 !=4)        //判断是否已经登录,若未登录则弹出提示框并返回登录界面.
        {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        sqlstr_update = "update [dzsw].[dbo].[SJ2B_KH_KaoHe_info] set [Leader_1_Opinion] ='" + tb1_ld1sp_yj.Text
