<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editwps.aspx.cs" Inherits="ntkoofficedemo_vs2008_.editwps" %>
        ...
        <div id="editmain_middle" class="editmain_middle">
            ...
            <!--JS功能按钮开始位置-->
                ...
                <div class="funbutton">
                    ...
                    <option value="esp/hetong">合同演示印章</option>
                    <option value="esp/hetong">财务演示印章</option>
                    <option value="esp/xingzheng">行政演示印章</option>
                    </select>
                    ...
                    <select id="picFileUrl" onchange="var signUrl=document.all('picFileUrl').options[document.all('picFileUrl').selectedIndex].value;if(signUrl==''){};else addServerSign(signUrl);">
                    <option value="" "selected">请选择服务器图片</option>
                    <option value="esp/smallattproduct.jpg" "selected">服务器图片1</option>
                ...
                <div id="formtop">
                    <table>
                        ...
                        <tr>
                            ...
                            <td width="20%"><input id="id" align="left" type="text" /></td>
                            <td width="7%">文件名称:</td>
                            <td width="40%"><input id="filename" align="left" type="text" /></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>其它数据:</td>
                            <td><input id="otherdata" align="left" type="text" /></td>
                            <td >上传文件:</td>
                            <td><input class="fileup" id="upattach" align="left" type="file" /></td>
                            <td>&nbsp;</td>
                        </tr>
